...
<script lang="ts">
	...
	import { tempState } from "$lib/websocket/index"
...
<div class="h-full">
	<h2 class="flex justify-between items-center pr-4 w-full h-[10%] text-2xl font-bold">{name.slice(0,1).toUpperCase()+name.slice(1).replaceAll("-", " ")}</h2>
